...
custom_content: |
  ...
  <ul>
  <li><strong>Accesso (Art. 15 GDPR):</strong> Ottenere conferma dell'esistenza dei tuoi dati personali e riceverne copia</li>
  <li><strong>Rettifica (Art. 16 GDPR):</strong> Richiedere la correzione di dati inesatti</li>
  ...
  <li><strong>Opposizione (Art. 21 GDPR):</strong> Opporti al trattamento dei tuoi dati</li>
  <li><strong>Revoca del consenso (Art. 7 GDPR):</strong> Revocare il consenso in qualsiasi momento</li>
  </ul>
