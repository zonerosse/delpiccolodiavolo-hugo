...
custom_content: |
  ...
  <img src="/images/lothar-matthaus-esposizione.avif" alt="JCH Lothar Matthäus del Piccolo Diavolo, maschio Staffordshire Bull Terrier tigrato in posa da esposizione" title="Lothar Matthäus del Piccolo Diavolo — Giovane Campione Italiano" width="620" height="983" fetchpriority="high" decoding="sync" srcset="/images/lothar-matthaus-esposizione-400w.avif 400w, /images/lothar-matthaus-esposizione.avif 800w" sizes="(max-width: 620px) 100vw, 620px">
  </div>
  </div>
  ...
  <span class="male-badge">🏆 Campione Sloveno · Giovane Campione Italiano</span>
  <h3 class="male-name">CH. SLO · J.CH. ITA Lothar Matthäus del Piccolo Diavolo</h3>
  <p style="margin:.3rem 0 0;color:#7a6a58;font-size:.95rem">Chiamato <strong>Tyson</strong></p>
  </div>
  ...
  <div class="male-header">
  <h3 class="male-name">Braveheart del Piccolo Diavolo</h3>
  </div>
  <div class="male-content">
  <div class="male-image">
  ...
  <article class="male-card">
  <div class="male-header">
  <h3 class="male-name">Papillon del Piccolo Diavolo</h3>
  </div>
  <div class="male-content">
  <div class="male-image">
  ...
  <h2>Integrità Genetica e Qualità</h2>
  <p>Eliminando dal nostro programma i cani da riproduzione portatori di malattie genetiche, proteggiamo le generazioni future da potenziali problemi di salute, favorendo così una discendenza robusta e resistente.</p>
  </section>
