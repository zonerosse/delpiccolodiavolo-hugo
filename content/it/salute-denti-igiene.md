...
custom_content: |
  ...
  <h1 class="hero-title">Igiene Orale e <em>Denti</em></h1>
  ...
  <span>Spazzolatura</span><span>Prevenzione Tartaro</span><span>Detartrasi</span><span>Snack Dentali</span><span>Dentizione Cuccioli</span><span>Gengivite</span><span>Dentifrici Veterinari</span><span>Masticativi Sicuri</span>
  <span>Spazzolatura</span><span>Prevenzione Tartaro</span><span>Detartrasi</span><span>Snack Dentali</span><span>Dentizione Cuccioli</span><span>Gengivite</span><span>Dentifrici Veterinari</span><span>Masticativi Sicuri</span>
  </div>
  </div>
  ...
  <div class="faq-item">
  <h3 class="faq-question">A che età iniziare a spazzolare i denti al cucciolo?</h3>
  <div class="faq-answer">
  <p>Puoi iniziare già a 8-10 settimane con manipolazioni delicate. Verso i 3-4 mesi introduci gradualmente lo spazzolino morbido. Più precoce è l'abitudine, più collaborativo sarà da adulto.</p>
  </div>
  </div>
  
  <div class="faq-item">
  <h3 class="faq-question">Quanto spesso devo spazzolare i denti al mio Staffy?</h3>
  <div class="faq-answer">
  <p>L'ideale è quotidianamente, ma 3-4 volte a settimana è già efficace. La costanza è più importante della frequenza. Ogni spazzolatura dovrebbe durare 1-2 minuti per lato.</p>
  </div>
  </div>
  
  <div class="faq-item">
  <h3 class="faq-question">Quali snack dentali sono sicuri per lo Staffy?</h3>
  <div class="faq-answer">
  <p>Scegli masticativi certificati VOHC, dimensionati per la potente mandibola. Evita ossa cotte, corna di cervo (rischio fratture), pelli pressate dubbie. Prediligi tendini essiccati, trachee bovine, giochi Kong o Nylabone.</p>
  </div>
  </div>
  
  <div class="faq-item">
  <h3 class="faq-question">Quando è necessaria la detartrasi professionale?</h3>
  <div class="faq-answer">
  <p>Quando il tartaro è visibilmente accumulato, le gengive sono infiammate o c'è alitosi persistente nonostante l'igiene domiciliare. Generalmente ogni 1-3 anni a seconda della predisposizione individuale.</p>
  </div>
  </div>
  
  <div class="faq-item">
  <h3 class="faq-question">Cosa fare se il mio Staffy ha alitosi forte?</h3>
  <div class="faq-answer">
  <p>L'alitosi intensa può indicare tartaro avanzato, gengivite, infezioni orali. Ispeziona il cavo orale: gengive rosse/gonfie, tartaro marrone, denti mobili richiedono visita veterinaria immediata.</p>
  </div>
  </div>
  
  <div class="faq-item">
  <h3 class="faq-question">I denti da latte del cucciolo non cadono: è normale?</h3>
  <div class="faq-answer">
  <p>I denti da latte dovrebbero cadere tra 4 e 6 mesi. Se persistono oltre i 7 mesi mentre i permanenti sono già spuntati (doppia dentizione), consulta il veterinario. Può essere necessaria l'estrazione.</p>
  </div>
  </div>
