...
custom_content: |
  ...
  <img src="/images/blog/standard-2.webp" alt="Linee di sangue Staffordshire Bull Terrier come orientarsi" width="800" height="600" fetchpriority="high">
  </div>
  </div>
  ...
  <span>Linee UK</span><span>Linee Irlandesi</span><span>Linee Continentali</span><span>Obiettivi Selezione</span><span>Test Genetici</span><span>Pedigree</span><span>Tipicità</span><span>Carattere</span>
  <span>Linee UK</span><span>Linee Irlandesi</span><span>Linee Continentali</span><span>Obiettivi Selezione</span><span>Test Genetici</span><span>Pedigree</span><span>Tipicità</span><span>Carattere</span>
  </div>
  </div>
  ...
  <p>Evita genealogie che estremizzano un singolo aspetto (testa spinta, ossatura eccessiva, altezza fuori standard) a scapito di movimento, funzionalità e salute. L'armonia complessiva è più importante di un dettaglio esasperato.</p>
