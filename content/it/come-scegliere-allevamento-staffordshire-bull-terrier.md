...
<p><strong>Il nostro.</strong> I referti dei riproduttori sono pubblicati sul sito, non inviati su richiesta: <a href="/docs/Genefast-Billy.pdf" target="_blank" rel="noopener" aria-label="Referto dei test genetici di Bilquis, PDF (si apre in una nuova scheda)">Bilquis</a>, <a href="/docs/Nora-Genefast.pdf" target="_blank" rel="noopener" aria-label="Referto dei test genetici di Nora, PDF (si apre in una nuova scheda)">Nora</a>, <a href="/docs/Minnie-GF.pdf" target="_blank" rel="noopener" aria-label="Referto dei test genetici di Minnie, PDF (si apre in una nuova scheda)">Minnie</a>. Per i maschi esterni pubblichiamo i referti che ci consegnano i loro proprietari, come per <a href="/docs/quash-antagene.pdf" target="_blank" rel="noopener" aria-label="Referto dei test genetici di Quash, PDF (si apre in una nuova scheda)">Quash</a> e <a href="/docs/ultima-evg-l2hga.pdf" target="_blank" rel="noopener" aria-label="Referto L2HGA di Ultima, PDF (si apre in una nuova scheda)">Ultima</a>, i genitori di Black Jack. Ogni microchip è leggibile.</p>

<h2>2. Esente per discendenza, o esente e basta?</h2>
...
<h2>3. Il pedigree, e chi c'è dentro</h2>
...
<ol>
<li>Perché avete scelto questo maschio per questa femmina?</li>
<li>Quali difetti ha la vostra linea, e cosa state cercando di correggere?</li>
<li>Che test hanno i genitori, e per quali patologie <em>non</em> sono testati?</li>
<li>Quante cucciolate ha avuto questa femmina, e a che età?</li>
<li>Cosa succede se fra due anni non riesco più a tenere il cane?</li>
</ol>

<p>L'ultima è la più rivelatrice. Chi alleva davvero risponde che il cane torna da lui.</p>

<h2>I segnali che valgono da soli</h2>

<p>Alcune cose bastano a chiudere il discorso, indipendentemente dal resto:</p>

<ul>
<li>Cuccioli sempre disponibili, in ogni periodo dell'anno</li>
<li>Rifiuto o rinvio continuo della visita</li>
<li>Proposta di consegna a metà strada o di spedizione</li>
<li>Cuccioli separati dalla madre prima dei 60 giorni</li>
<li>Pedigree presentato come opzione a pagamento</li>
<li>Nessun referto genetico, o referti senza microchip</li>
<li>Fretta di farti decidere, o "c'è un'altra famiglia interessata"</li>
