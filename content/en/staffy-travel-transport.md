...
custom_content: |
  ...
  <p>Travel on an empty stomach, or with a very small meal 3 hours before. Position the dog so that it faces forward and can see the horizon, which is one reason a crate in the boot with a view through the rear seats works better than a footwell. Keep the interior cool and quiet, ventilate rather than blast air conditioning, and stop every 2 hours.</p>
  <p>Build tolerance deliberately: sit in the stationary car with the engine off and give a treat, then a two-minute drive that ends somewhere pleasant, then 5 minutes. The goal is that most journeys end at a park rather than a veterinary surgery.</p>
