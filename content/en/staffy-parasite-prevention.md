...
custom_content: |
  ...
  <img src="/images/blog/salute-1.webp" alt="Parasite prevention Staffordshire Bull Terrier" width="800" height="600" fetchpriority="high">
  </div>
  </div>
  ...
  <h2>Fleas</h2>
  <p>The flea you see on the dog represents about five per cent of the infestation. The remainder — eggs, larvae and pupae — is in the carpet, the bedding, the sofa and the cracks in the floor. This is the single most useful fact about fleas, because it explains why treating the dog alone repeatedly fails, and why an infestation appears to return a fortnight after it was solved.</p>
  <p>Signs to look for: scratching concentrated at the base of the tail and along the back, small scabs, and flea dirt, which looks like specks of black grit and turns rust-red on damp white paper. That test is definitive and takes ten seconds.</p>
  <p>Treatment means treating every animal in the household simultaneously, on the same day, plus the environment: hot washing of all bedding, thorough vacuuming including under furniture with immediate disposal of the bag, and in heavy infestations an environmental product with an insect growth regulator. Repeat after three weeks to catch the generation that hatches from pupae, which are resistant to everything.</p>
  ...
  <p>To remove one, use a tick hook or fine tweezers as close to the skin as possible, and pull steadily with a twisting motion. Do not apply oil, alcohol or a flame: a distressed tick regurgitates, which is precisely how pathogens are transmitted. Note the date, and watch for fever, lethargy or dark urine over the following three weeks.</p>

  <h2>Intestinal worms</h2>
  <p>Roundworms, hookworms, whipworms and tapeworms are the common group. Puppies are effectively born with roundworm from the dam and must be wormed on a strict schedule: every two weeks from two weeks of age until twelve weeks, then monthly to six months. This is the breeder's responsibility for the first part and the owner's thereafter, and the dates should be written in the health record you receive.</p>
  <p>Adults are typically treated every three months, adjusted upwards for dogs that hunt, scavenge or live with small children. Tapeworm is transmitted by ingesting fleas, which is one more reason the two problems are managed together rather than separately.</p>
  ...
  <p><strong>My dog never leaves the garden. Does it still need prevention?</strong> Yes. Mosquitoes carrying heartworm and sandflies carrying leishmaniasis do not require the dog to travel, and flea eggs arrive on shoes and clothing. A garden-only dog needs the same protection as any other.</p>
  <p><strong>Can I use the same product all year?</strong> Often yes, and consistency is valuable because gaps are where problems start. What matters is that the combination covers fleas, ticks, heartworm and intestinal worms across the year, not that it is a single product.</p>
  <p><strong>Is a collar as effective as a spot-on?</strong> For repelling sandflies, the evidence for collars with proven anti-feeding action is strong. For fleas and ticks, both formats work when used correctly. The practical difference is that a collar must be worn continuously and correctly fitted to do anything at all.</p>
  <p><strong>I found a tick and pulled it out. Should I worry?</strong> Watch for three weeks and note the date. Fever, lethargy, pale gums or dark urine mean an immediate veterinary visit with that date in hand. Most tick bites transmit nothing, but the ones that do move quickly.</p>
