...
custom_content: |
  ...
  <img src="/images/blog/hero-default.webp" alt="Staffordshire Bull Terrier: is it the right dog for you" width="800" height="600" fetchpriority="high">
  </div>
  </div>
  <div class="hero-content">
  <span class="hero-eyebrow">Getting to Know the Breed</span>
  <h1 class="hero-title">Is the <em>Staffordshire Bull Terrier</em> the right dog for you?</h1>
  <p class="hero-subtitle">Pros, cons and who it really suits — no sugar-coating</p>
  <div class="hero-meta">
  ...
  <span>Temperament</span><span>Real Pros</span><span>Real Cons</span><span>Who It Suits</span><span>Children</span><span>Commitment</span><span>Costs</span><span>FAQ</span>
  <span>Temperament</span><span>Real Pros</span><span>Real Cons</span><span>Who It Suits</span><span>Children</span><span>Commitment</span><span>Costs</span><span>FAQ</span>
  </div>
  </div>
  ...
  <span>Is it the right dog for you?</span>
  </nav>
  ...
  <h3>1. Affection out of the ordinary</h3>
  ...
  <p style="margin:0 0 .5rem;color:#5c4a3a;line-height:1.6">However reliable and gentle, <strong>no dog should ever be left alone with young children without an adult's supervision</strong>. This applies to the Staffordshire Bull Terrier as to any breed: it is a fundamental safety rule, in the interest of both the child and the dog.</p>
  <p style="margin:0;color:#5c4a3a;line-height:1.6">From the moment of placement, the management and supervision of the dog are the owner's responsibility: <strong>the kennel accepts no liability</strong> for behaviour or accidents resulting from management that does not follow these guidelines.</p>
  </div>
  
  <h3>3. An ideal size for modern life</h3>
  <p>Sturdy enough not to be "delicate", compact enough to live well even in a flat (if it gets out and burns off energy enough). It does not take up the space of a giant molosser.</p>
  
  <h3>4. Very short coat, easy to manage</h3>
  ...
  <h3>1. It can't stand being alone</h3>
  ...
  <h3>4. Considerable physical strength</h3>
  <p>In a small body there is surprising power. On the lead, an untrained Staffy "pulls like a tractor". You need to teach it good manners from puppyhood — it is not a dog for those who don't want to dedicate time to training.</p>
  
  <h3>5. Terrier stubbornness</h3>
  ...
  <ul>
  <li>You want a <strong>present, affectionate</strong> dog, a full member of the family</li>
  ...
  <h2>It may NOT be the right dog IF…</h2>
  <ul>
  <li>You are out of the house many hours and the dog would be alone for a long time</li>
  <li>You want an independent dog that "looks after itself"</li>
  <li>You have no time or desire for exercise and training</li>
  <li>You want to let it loose among many dogs without having to think about it</li>
  <li>You expect an "easy" dog with no commitment: no dog is, and this one less than others at the start</li>
  </ul>
  ...
  <p>Let's put numbers to it, so there are no surprises:</p>
  <ul>
  <li><strong>Exercise:</strong> at least 1 hour a day between walks and play, more when young</li>
  ...
  <a href="/en/blog/" title="Advice articles">choosing a breed</a>
  </p>
  </div>
