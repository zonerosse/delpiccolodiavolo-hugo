...
custom_content: |
  ...
  <span class="hero-eyebrow">GDPR Information</span>
  ...
  <ul>
  <li><strong>Access (Art. 15 GDPR):</strong> Obtain confirmation of the existence of your personal data and receive a copy</li>
  <li><strong>Rectification (Art. 16 GDPR):</strong> Request correction of inaccurate data</li>
  <li><strong>Erasure (Art. 17 GDPR):</strong> Request deletion of data ("right to be forgotten")</li>
  <li><strong>Restriction (Art. 18 GDPR):</strong> Request restriction of processing</li>
  <li><strong>Portability (Art. 20 GDPR):</strong> Receive data in structured format</li>
  <li><strong>Objection (Art. 21 GDPR):</strong> Object to processing of your data</li>
  <li><strong>Withdrawal of consent (Art. 7 GDPR):</strong> Withdraw consent at any time</li>
  </ul>
