...
custom_content: |
  ...
  <p>The simplest change costs nothing and works immediately: stop feeding from a bowl. A puppy's daily ration used as currency turns every meal into a training session and every mealtime into fifteen minutes of occupation instead of ninety seconds.</p>
  <p>Scatter feeding in grass or on a snuffle mat makes the puppy use its nose, which is intrinsically calming. A portion frozen into a rubber toy with a little wet food occupies a puppy for twenty minutes and is invaluable when you need to work. Kibble hidden in a cardboard egg box, which the puppy may destroy in the process, costs nothing and provides real satisfaction.</p>
  ...
  <p>Short training sessions of three to five minutes, several times a day, are far more effective than one long one and are excellent mental work in themselves. A puppy can learn sit, down, its name, a hand touch and the beginnings of a stay well before four months.</p>
  ...
  <p>Morning: breakfast scattered or in a puzzle feeder, ten minutes. Midday: a three-minute training session, then a stuffed toy while you work. Afternoon: a nose work game, ten to fifteen minutes. Evening: dinner used for training, then something to chew while the household settles.</p>
  <p>That is under forty minutes across a day, and it changes the behaviour of a young Staffordshire Bull Terrier more than any amount of additional walking. Owners who adopt it almost always report the same thing: the puppy sleeps.</p>
  ...
  <p>Working when the puppy is already overtired. A puppy that has been awake for four hours does not need stimulation, it needs sleep — and puppies of this age sleep sixteen to eighteen hours a day for good reason.</p>
  ...
  <p>And repeating the same game indefinitely. Novelty is a large part of what makes mental work tiring; a puzzle solved fifty times is no longer a puzzle.</p>

  <h2>Frequently asked questions</h2>
  <p><strong>How long should a session be?</strong> Three to five minutes for a young puppy, up to fifteen for nose work by five or six months. Several short sessions beat one long one.</p>
  ...
  <p><strong>Is nose work suitable for a very young puppy?</strong> Yes, from eight weeks, at the simplest level. It is the safest activity there is for a growing dog: no impact, no repetition, no load on joints.</p>
